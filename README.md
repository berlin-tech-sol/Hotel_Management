<div align="center">
	<a href="https://www.qloapps.com"><img src="https://forums.qloapps.com/assets/uploads/system/site-logo.png?v=hkl8e1230fo" alt="Berlin Techs"></a>
	<br>
	<p>
		<b>Berlin Techs - An open source and free platform to launch your own hotel booking website</b>
	</p>
</div>
...
- [Topics](#topics)
	...
	- [Documentation & Demo](#documentation--demo)
		- [Berlin Techs Documentation](#berlin-techs-documentation)
		- [Berlin Techs Demo](#berlin-techs-demo)
...
Berlin Techs is one kind of a true open-source hotel reservation system and a booking engine. The system is dedicated to channeling the power of the open-source community to serve the hospitality industry.

From small independent hotels to big hotel chains, Berlin Techs is a one-stop solution for all your hotel business needs.

You will be able to launch your hotel website, showcase your property and take and manage bookings.

### Requirements

In order to install Berlin Techs you will need the following server configurations for hosted and local serves.
...
**1.** You can install Berlin Techs easily after downloading Berlin Techs. There are easy steps for the installation process. Please visit [Berlin Techs Installation Guide](https://qloapps.com/install-qloapps/) and follow the steps for the successful installation.

**2.** Or you can install Berlin Techs with docker image. For the docker image of Berlin Techs, please visit [Dockerize image of Berlin Techs](https://hub.docker.com/r/webkul/qloapps_docker) <br>
* Docker pull command
~~~
...
Berlin Techs Core is licensed under OSL-3.0 and Modules authored by Webkul have their applicable license, LICENSE.md, kept inside their root directories, while other modules are licensed under AFL-3.0.
...
Please don't disclose security vulnerabilities publicly. If you find any security vulnerability in Berlin Techs then please email us: mailto:support@qloapps.com.

### Documentation & Demo

#### Berlin Techs Documentation
...
For more information about the contribution process please check **[Contribute to Berlin Techs](/CONTRIBUTING.md)**
