...
abstract class ModuleCore
{
    ...
    /** @var array filled with known compliant Berlin Techs versions */
    ...
    public function __construct($name = null, ?Context $context = null)
    {
        ...
        // for Berlin Techs version compliancy
    ...
    public function install()
    {
        ...
        if (!$this->checkCompliancy()) {
            $this->_errors[] = Tools::displayError('The version of your module is not compliant with your Berlin Techs version.');
            return false;
        }
