            ...
            'general' => array(
                ...
                'fields' =>    array(
                    ...
                    'PS_COOKIE_LIFETIME_BO' => array(
                        ...
                        'hint' => $this->l('Set the amount of hours during which the back office cookies are valid. After that amount of time, the Berlin Techs user will have to log in again.'),
                        'validation' => 'isInt',
                        'cast' => 'intval',
                        'type' => 'text',
                        'suffix' => $this->l('hours'),
