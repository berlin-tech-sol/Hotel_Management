...
class AdminInformationControllerCore extends AdminController
{
    ...
    public function getTestResult()
    {
        $tests_errors = array(
            ...
            'files' => $this->l('Some Berlin Techs files are missing from your server.'),
             'new_phpversion' => sprintf($this->l('You are using PHP %s version. Soon, the latest PHP version supported by Berlin Techs will be PHP 8.1. To make sure you’re ready for the future, we recommend you to upgrade to PHP 8.1 now!'), phpversion()),
