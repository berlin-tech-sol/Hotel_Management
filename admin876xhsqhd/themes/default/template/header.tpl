			...
			<div class="navbar-header">
				...
				<ul id="header_employee_box">
					{if isset($upgrade_info->update_available) && $upgrade_info->update_available > 0}
						<li class="hidden-md hidden-sm hidden-xs"><a href="{$upgrade_info->upgrade_url}">{l s='Berlin Techs Update Availabe:'} {$upgrade_info->latest_availabe}</a></li>
					{/if}
					<li class="hidden-sm hidden-xs">
						<a target="_blank" href="https://qloapps.com/addons/" class="toolbar_btn" title="{l s='Explore Berlin Techs Addons'}">
							<i class="icon-chain-broken"></i>
							{l s='Explore Berlin Techs Addons'}
						</a>
					</li>
					{if {$base_url}}
						<li>
