                    ...
                    <section class="dash_links widget panel">
                        <h3><i class="icon-link"></i> {l s="Help Center"}</h3>
                            <dl>
                                ...
                                <dd>{l s="Berlin Techs User Guide"}</dd>
                            </dl>
                            <dl>
                                <dt><a href="https://forums.qloapps.com/" class="_blank">{l s="Berlin Techs Forum"}</a></dt>
                                <dd>{l s="Connect with the Berlin Techs community"}</dd>
                            </dl>
                            <dl>
                                <dt><a href="https://qloapps.com/addons/" class="_blank">{l s="Berlin Techs Addons"}</a></dt>
                                <dd>{l s="Enhance your store Berlin Techs modules"}</dd>
                            </dl>
                            <dl>
