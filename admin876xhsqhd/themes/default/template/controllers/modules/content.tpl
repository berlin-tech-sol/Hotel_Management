		...
		<div class="defaultForm form-horizontal">
				...
				<div class="panel">
					<div class="row">
						<div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
							<img class="img-responsive" alt="Berlin Techs Addons" src="themes/default/img/prestashop-addons-logo.png">
						</div>
				...
				<div class="panel" id="">
					...
					<div class="form-wrapper">
						<div class="form-group">
							<p>{l s='To add a new module, simply connect to your Berlin Techs Addons account and all your purchases will be automatically imported.'}</p>
						</div>
					</div><!-- /.form-wrapper -->
			...
			{/if}
				...
				<div class="alert alert-info">
					...
					<p>{l s='Please note that for security reasons, you can only add modules that are being distributed on Berlin Techs Addons, the official marketplace.'}</p>
				</div>
