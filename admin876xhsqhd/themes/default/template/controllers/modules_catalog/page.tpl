...
<div id="catalog-center-column">
    {if isset($modules) && $modules}
        ...
        <div class="panel explore-panel text-center">
            ...
            <a href="https://qloapps.com/addons/" class="btn btn-primary btn-lg">{l s='Berlin Techs Addons'}</a>
        </div>
    {/if}
    {if isset($themes) && $themes}
        ...
        <div class="panel explore-panel text-center">
            {l s='Explore all themes of Berlin Techs'}&nbsp;
            <a href="https://store.webkul.com/Qloapps/responsive.html" class="btn btn-primary btn-lg">{l s='Berlin Techs Themes'}</a>
        </div>
    {/if}
</div>
