...
{block name="override_tpl"}
	...
	<div class="row">
		<div class="alert alert-warning">
			...
			<ol>
				<li>{l s='Berlin Techs is not responsible for your database, its backups and/or recovery.'}</li>
				<li>{l s='Berlin Techs is open-source software. You are using it at your own risk under the license agreement.'}</li>
