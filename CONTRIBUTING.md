# Contribute to Berlin Techs

Berlin Techs is an open-source software and we all know that community contributions lie at the heart of any open-source software. It is the essence of an open-source that a diverse group of individuals collaborate and innovate the best possible solutions.

Here are the ways you can contribute to the Berlin Techs project.
...
In Berlin Techs we follow a modular approach to bring functionalities into the system. The system has its native modules for different features.
...
If you have an idea to make the system more optimized and you can make the system work better then it's time to make a pull request at the [Berlin Techs Github repository](https://github.com/webkul/hotelcommerce).

The better-written code the better the software performance.

### Report Security Issues

Berlin Techs values the contributions of the security research community, and we look forward to working with you to minimize risk to Berlin Techs users.

If you have found a security issue in Berlin Techs, please do not use the issue tracker and don't publish it publicly. Instead, report the security issue to [support@qloapps.com](mailto:support@qloapps.com) or contact [Berlin Techs Support](https://webkul.uvdesk.com/en/customer/create-ticket/). So that we can act on it immediately to avoid as much damage as we can.
...
Bugless development is impossible, we can just try to leave as minimum bugs in the system as we can. At Berlin Techs also we try our best to make the system free of bugs.
