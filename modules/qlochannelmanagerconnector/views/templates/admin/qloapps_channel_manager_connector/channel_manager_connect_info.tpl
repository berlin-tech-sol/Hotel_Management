            ...
            <div class="qcm_info_block">
                <div class="row">
                    ...
                    <div class="connect_info_txt col-sm-12 margin-bottom-10">
                        **{l s='Connection status with channel manager is showing according to the bookings fetched from Berlin Techs Channel Manager.' mod='qlochannelmanagerconnector'}
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row flex-display">
                    ...
                    <div class="col-md-10 qcm_info_wrapper">
                        ...
                        <div class="qcm_info_block_content">
                            ...
                            <ul>
                                <li>{l s='Enable Berlin Techs webservice from Webservice tab.' mod='qlochannelmanagerconnector'} <a target="blank" href="{$link->getAdminLink('AdminWebservice')}"><i class="icon-external-link"></i></a></li>
                                ...
                                <li>{l s='Create account on Channel Manager' mod='qlochannelmanagerconnector'} <a target="blank" class="qcm-link" href="https://channels.qloapps.com/"><i class="icon-external-link"></i></a>. {l s=' Then enter Berlin Techs webservice credentials under PMS settings of channel manager .' mod='qlochannelmanagerconnector'}</li>
                                <li>{l s='Synchronize and map Berlin Techs hotels and room types in channel manager.' mod='qlochannelmanagerconnector'}</li>
                            </ul>
                ...
                <div class="row flex-display">
                    ...
                    <div class="col-md-10 qcm_info_wrapper">
                        ...
                        <div class="qcm_info_block_content">
                            ...
                            <br>
                            {l s='Berlin Techs channel manager synchronizes inventory, rates, restrictions with all connected OTA channels and automated bookings sync connected OTAs and Berlin Techs PMS.' mod='qlochannelmanagerconnector'}
                        </div>
                        <div class="qcm_info_explore">
                    ...
                    <div class="col-md-11 qcm_info_wrapper">
                        ...
                        <div class="qcm_info_block_content">
                            <ul>
                                ...
                                <li>{l s='Already integrated with Berlin Techs PMS that auto-synchronize inventories for the bookings created on Berlin Techs PMS and connected OTA channels.' mod='qlochannelmanagerconnector'}</li>
                                <li>{l s='Getting more property impressions by travellers on the world’s leading Online Travel Agencies as well as on the Berlin Techs Hotel booking website will boost your online brand visibility and returns you more reservations.' mod='qlochannelmanagerconnector'}</li>
                            </ul>
                        </div>
                        <div class="qcm_info_explore">
